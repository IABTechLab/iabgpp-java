...
public class GvlV3Test {
  ...
  public void test() throws IOException {
    Gvl gvl =
        new Loader()
            .globalVendorList(
                GvlV3Test.class
                    .getClassLoader()
                    .getResourceAsStream("vendorlist/v3.0/vendor-list.json"));
    ...
    Assertions.assertEquals(
        "Match and combine data from other data sources", gvl.getFeatures().get(0).getName());
    Assertions.assertEquals(
    ...
    Assertions.assertEquals(
        ...
        gvl.getDataCategories().get().get(0).getDescription());

    Assertions.assertEquals(1, gvl.getVendors().get(0).getId());
    Assertions.assertFalse(gvl.getVendors().get(0).getDeletedDate().isPresent());
    Assertions.assertEquals(
        "Exponential Interactive, Inc d/b/a VDX.tv", gvl.getVendors().get(0).getName());
    Assertions.assertEquals(
        Arrays.asList(1, 2, 3, 4, 7, 8, 9, 10), gvl.getVendors().get(0).getPurposes());
    Assertions.assertTrue(gvl.getVendors().get(0).getLegIntPurposes().isPresent());
    Assertions.assertEquals(
        Collections.emptyList(), gvl.getVendors().get(0).getLegIntPurposes().get());
    Assertions.assertEquals(
        Arrays.asList(7, 8, 9, 10), gvl.getVendors().get(0).getFlexiblePurposes());
    ...
    Assertions.assertTrue(
        gvl.getVendors().get(0).getDataRetention().get().getStdRetention().isPresent());
    Assertions.assertEquals(
        397, gvl.getVendors().get(0).getDataRetention().get().getStdRetention().get());
    Assertions.assertTrue(gvl.getVendors().get(0).getDataRetention().get().getPurposes().isEmpty());
    Assertions.assertTrue(
        gvl.getVendors().get(0).getDataRetention().get().getSpecialPurposes().isEmpty());
    ...
    Assertions.assertEquals(
        "https://vdx.tv/privacy/", gvl.getVendors().get(0).getUrls().get().get(0).getPrivacy());
    Assertions.assertTrue(
        gvl.getVendors().get(0).getUrls().get().get(0).getLegIntClaim().isPresent());
    Assertions.assertEquals(
        "https://cdnx.exponential.com/wp-content/uploads/2018/04/Balancing-Assessment-for-Legitimate-Interest-Publishers-v2.pdf",
        gvl.getVendors().get(0).getUrls().get().get(0).getLegIntClaim().get());
    Assertions.assertTrue(gvl.getVendors().get(0).getDataDeclaration().isPresent());
    Assertions.assertEquals(
        Arrays.asList(1, 3, 4, 6, 8, 10, 11), gvl.getVendors().get(0).getDataDeclaration().get());
    Assertions.assertTrue(gvl.getVendors().get(0).getDeviceStorageDisclosureUrl().isPresent());
    Assertions.assertEquals(
        "https://vdxtv.expo.workers.dev",
        gvl.getVendors().get(0).getDeviceStorageDisclosureUrl().get());
    ...
    Assertions.assertEquals(
        Collections.emptyList(), gvl.getVendors().get(4).getLegIntPurposes().get());
    ...
    Assertions.assertTrue(
        gvl.getVendors().get(4).getDataRetention().get().getStdRetention().isPresent());
    Assertions.assertEquals(
        0, gvl.getVendors().get(4).getDataRetention().get().getStdRetention().get());
    Assertions.assertEquals(
        1, gvl.getVendors().get(4).getDataRetention().get().getPurposes().size());
    Assertions.assertEquals(
        4320, gvl.getVendors().get(4).getDataRetention().get().getPurposes().get(7));
    Assertions.assertEquals(
        2, gvl.getVendors().get(4).getDataRetention().get().getSpecialPurposes().size());
    Assertions.assertEquals(
        392, gvl.getVendors().get(4).getDataRetention().get().getSpecialPurposes().get(1));
    Assertions.assertEquals(
        4320, gvl.getVendors().get(4).getDataRetention().get().getSpecialPurposes().get(2));
    ...
    Assertions.assertEquals(
        ...
        gvl.getVendors().get(4).getUrls().get().get(0).getPrivacy());
    Assertions.assertTrue(
        gvl.getVendors().get(4).getUrls().get().get(0).getLegIntClaim().isPresent());
    Assertions.assertEquals(
        "https://www.beeswax.com/privacy/",
        gvl.getVendors().get(4).getUrls().get().get(0).getLegIntClaim().get());
    Assertions.assertTrue(gvl.getVendors().get(4).getDataDeclaration().isPresent());
    Assertions.assertEquals(
        Arrays.asList(1, 2, 3, 4, 6, 8, 9, 11), gvl.getVendors().get(4).getDataDeclaration().get());
    Assertions.assertTrue(gvl.getVendors().get(4).getDeviceStorageDisclosureUrl().isPresent());
    Assertions.assertEquals(
        "https://beeswax.com/devicedisclosure.json",
        gvl.getVendors().get(4).getDeviceStorageDisclosureUrl().get());
