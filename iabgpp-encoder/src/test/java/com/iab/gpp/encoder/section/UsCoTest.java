...
public class UsCoTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT_NOTICE, 0);
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT, 1);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT_NOTICE, 0);
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT, 2);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT_NOTICE, 1);
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT, 0);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT_NOTICE, 2);
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT, 0);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usCo.setFieldValue(UsCoField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usCo.setFieldValue(UsCoField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usCo.setFieldValue(UsCoField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usCo.setFieldValue(UsCoField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usCo.setFieldValue(UsCoField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usCo.setFieldValue(UsCoField.SALE_OPT_OUT_NOTICE, 1);
      usCo.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
