...
public class UsDeTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT_NOTICE, 0);
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT, 1);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT_NOTICE, 0);
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT, 2);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT_NOTICE, 1);
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT, 0);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT_NOTICE, 2);
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT, 0);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usDe.setFieldValue(UsDeField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usDe.setFieldValue(UsDeField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usDe.setFieldValue(UsDeField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usDe.setFieldValue(UsDeField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usDe.setFieldValue(UsDeField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usDe.setFieldValue(UsDeField.SALE_OPT_OUT_NOTICE, 1);
      usDe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
