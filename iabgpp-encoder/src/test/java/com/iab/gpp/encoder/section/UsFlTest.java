...
public class UsFlTest {
  ...
  public void testEncode2() {
    ...
    try {
      ...
      usFl.setFieldValue(
          UsFlField.SENSITIVE_DATA_PROCESSING, Arrays.asList(2, 1, 0, 2, 1, 0, 2, 1));
  ...
  public void testSetInvalidValues() {
    ...
    try {
      usFl.setFieldValue(
          UsFlField.SENSITIVE_DATA_PROCESSING, Arrays.asList(0, 1, 2, 3, 1, 2, 0, 1));
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testDecode1() throws DecodingException {
    ...
    Assertions.assertEquals(
        Arrays.asList(2, 1, 0, 2, 1, 0, 2, 1), usFl.getSensitiveDataProcessing());
