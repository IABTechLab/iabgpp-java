...
public class EncodableOptimizedFixedRangeTest {
  ...
  private EncodableOptimizedFixedRange<UsNatField> encodableOptimizedFixedRange =
  ...
  public void testEncode1() {
    ...
    Assertions.assertEquals(
        "00000000001100000000000000001000000000001000000000000000000000001", builder.toString());
  }
  ...
  public void testDecode1() {
    Assertions.assertEquals(
        Set.of(12, 24, 48),
        encodableOptimizedFixedRange.decode(
            BitString.of("00000000001100000000000000001000000000001000000000000000000000001"),
            null));
  }
  ...
  public void testDecode2() {
    Assertions.assertEquals(
        Set.of(18, 30),
        encodableOptimizedFixedRange.decode(
            BitString.of("00000000000111100000000000000000001000000000001"), null));
  }
  ...
  public void testDecode3() {
    Assertions.assertEquals(
        Set.of(28),
        encodableOptimizedFixedRange.decode(
            BitString.of("000000000001110000000000000000000000000000001"), null));
  }
  ...
  public void testDecode4() {
    Assertions.assertEquals(
        Set.of(29),
        encodableOptimizedFixedRange.decode(
            BitString.of("0000000000011101100000000000100000000000011101"), null));
  }
}
