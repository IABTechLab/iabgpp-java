...
public class UsTnTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT_NOTICE, 0);
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT, 1);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT_NOTICE, 0);
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT, 2);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT_NOTICE, 1);
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT, 0);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT_NOTICE, 2);
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT, 0);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usTn.setFieldValue(UsTnField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usTn.setFieldValue(UsTnField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usTn.setFieldValue(UsTnField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usTn.setFieldValue(UsTnField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usTn.setFieldValue(UsTnField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usTn.setFieldValue(UsTnField.SALE_OPT_OUT_NOTICE, 1);
      usTn.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
