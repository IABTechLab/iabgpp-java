...
public class UsNhTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT_NOTICE, 0);
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT, 1);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT_NOTICE, 0);
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT, 2);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT_NOTICE, 1);
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT, 0);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT_NOTICE, 2);
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT, 0);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usNh.setFieldValue(UsNhField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usNh.setFieldValue(UsNhField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usNh.setFieldValue(UsNhField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usNh.setFieldValue(UsNhField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNh.setFieldValue(UsNhField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usNh.setFieldValue(UsNhField.SALE_OPT_OUT_NOTICE, 1);
      usNh.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
