...
public class UsNeTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT_NOTICE, 0);
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT, 1);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT_NOTICE, 0);
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT, 2);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT_NOTICE, 1);
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT, 0);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT_NOTICE, 2);
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT, 0);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usNe.setFieldValue(UsNeField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usNe.setFieldValue(UsNeField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usNe.setFieldValue(UsNeField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usNe.setFieldValue(UsNeField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNe.setFieldValue(UsNeField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usNe.setFieldValue(UsNeField.SALE_OPT_OUT_NOTICE, 1);
      usNe.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
