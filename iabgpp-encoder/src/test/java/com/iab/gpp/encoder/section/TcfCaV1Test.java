...
public class TcfCaV1Test {
  ...
  public void testEncode1() throws EncodingException, InvalidFieldException {
    ...
    Assertions.assertEquals("BPSG_8APSG_8AAAAAAENAABAAAAAAAAAAAAAAAAA.YAAAAAAAAAA", tcfCaV1.encode());
  }
  ...
  public void testEncode2() throws EncodingException, InvalidFieldException {
    ...
    Assertions.assertEquals("BPSG_8APSG_8AAyACAENGdBgf_gfgAfgfgBgABABAAABAB4AACAC.fHHHA4444ao", tcfCaV1.encode());
  }
