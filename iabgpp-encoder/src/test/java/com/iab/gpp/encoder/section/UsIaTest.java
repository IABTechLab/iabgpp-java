...
public class UsIaTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT_NOTICE, 0);
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT, 1);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT_NOTICE, 0);
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT, 2);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT_NOTICE, 1);
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT, 0);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT_NOTICE, 2);
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT, 0);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usIa.setFieldValue(UsIaField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usIa.setFieldValue(UsIaField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usIa.setFieldValue(UsIaField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usIa.setFieldValue(UsIaField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usIa.setFieldValue(UsIaField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usIa.setFieldValue(UsIaField.SALE_OPT_OUT_NOTICE, 1);
      usIa.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
