...
public class UsNjTest {
  ...
  public void testEncode2() {
    ...
    usNj.setFieldValue(
        UsNjField.SENSITIVE_DATA_PROCESSING, Arrays.asList(2, 1, 0, 2, 1, 0, 2, 1, 0, 1));
  ...
  public void testSetInvalidValues() {
    ...
    try {
      usNj.setFieldValue(
          UsNjField.SENSITIVE_DATA_PROCESSING, Arrays.asList(0, 1, 2, 3, 1, 2, 0, 1));
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testDecode1() throws DecodingException {
    ...
    Assertions.assertEquals(
        Arrays.asList(2, 1, 0, 2, 1, 0, 2, 1, 0, 1), usNj.getSensitiveDataProcessing());
    Assertions.assertEquals(
        Arrays.asList(2, 1, 0, 2, 1), usNj.getKnownChildSensitiveDataConsents());
