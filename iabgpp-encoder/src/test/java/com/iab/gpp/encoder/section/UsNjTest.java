...
public class UsNjTest {
  ...
  public void testValidateSale() {
    ...
    try {
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT_NOTICE, 0);
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT, 1);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT_NOTICE, 0);
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT, 2);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT_NOTICE, 1);
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT, 0);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT_NOTICE, 2);
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT, 0);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateTargetedAdvertising() {
    ...
    try {
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT, 1);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 0);
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT, 2);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 1);
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT_NOTICE, 2);
      usNj.setFieldValue(UsNjField.TARGETED_ADVERTISING_OPT_OUT, 0);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
  ...
  public void testValidateMspaServiceProviderMode() {
    ...
    try {
      usNj.setFieldValue(UsNjField.MSPA_SERVICE_PROVIDER_MODE, 1);
      usNj.setFieldValue(UsNjField.MSPA_OPT_OUT_OPTION_MODE, 0);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.MSPA_SERVICE_PROVIDER_MODE, 2);
      usNj.setFieldValue(UsNjField.MSPA_OPT_OUT_OPTION_MODE, 2);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
    ...
    try {
      usNj.setFieldValue(UsNjField.MSPA_SERVICE_PROVIDER_MODE, 0);
      usNj.setFieldValue(UsNjField.SALE_OPT_OUT_NOTICE, 1);
      usNj.encode();
      Assertions.fail("Expected ValidationException");
    } catch (ValidationException e) {
