...
public class UsTxV1Field {
  ...
  //@formatter:off
  public static List<String> USTXV1_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsTxV1Field.VERSION,
  ...
  //@formatter:off
  public static List<String> USTXV1_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsTxV1Field.GPC_SEGMENT_TYPE,
      UsTxV1Field.GPC
  });
  //@formatter:on
}
