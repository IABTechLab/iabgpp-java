...
public class UsDeField {
  ...
  //@formatter:off
  public static final List<String> USDE_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsDeField.VERSION,
  ...
  //@formatter:off
  public static final List<String> USDE_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
