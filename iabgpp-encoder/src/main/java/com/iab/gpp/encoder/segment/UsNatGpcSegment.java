...
public final class UsNatGpcSegment extends AbstractLazilyEncodableSegment<UsNatField, EncodableBitStringFields<UsNatField>> {
  ...
  protected EncodableBitStringFields<UsNatField> initializeFields() {
    EncodableBitStringFields<UsNatField> fields = new EncodableBitStringFields<>(UsNatField.USNAT_GPC_SEGMENT_FIELD_NAMES);
    fields.put(UsNatField.GPC_SEGMENT_TYPE, new EncodableFixedInteger(2, 1));
    fields.put(UsNatField.GPC_SEGMENT_INCLUDED, new UnencodableBoolean(true));
