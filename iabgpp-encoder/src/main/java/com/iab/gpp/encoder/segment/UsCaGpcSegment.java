...
public final class UsCaGpcSegment extends AbstractLazilyEncodableSegment<UsCaField, EncodableBitStringFields<UsCaField>> {
  ...
  protected EncodableBitStringFields<UsCaField> initializeFields() {
    EncodableBitStringFields<UsCaField> fields = new EncodableBitStringFields<>(UsCaField.USCA_GPC_SEGMENT_FIELD_NAMES);
