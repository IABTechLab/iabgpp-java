...
public class UsNatField {
  ...
  //@formatter:off
  public static final List<String> USNAT_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsNatField.VERSION,
  ...
  //@formatter:off
  public static final List<String> USNAT_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
