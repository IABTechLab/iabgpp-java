...
public final class UsVaCoreSegment extends AbstractLazilyEncodableSegment<UsVaField, EncodableBitStringFields<UsVaField>> {
  ...
  @Override
  protected EncodableBitStringFields<UsVaField> initializeFields() {
    EncodableBitStringFields<UsVaField> fields = new EncodableBitStringFields<>(UsVaField.USVA_CORE_SEGMENT_FIELD_NAMES);
  ...
  @Override
  protected StringBuilder encodeSegment(EncodableBitStringFields<UsVaField> fields) {
    BitStringBuilder bitString = fields.encode();
    return base64UrlEncoder.encode(bitString);
  }

  @Override
  protected void decodeSegment(CharSequence encodedString, EncodableBitStringFields<UsVaField> fields) {
