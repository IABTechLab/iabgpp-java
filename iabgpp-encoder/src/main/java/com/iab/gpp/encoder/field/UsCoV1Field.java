...
public class UsCoV1Field {
  ...
  //@formatter:off
  public static final List<String> USCOV1_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsCoV1Field.VERSION,
  ...
  //@formatter:off
  public static final List<String> USCOV1_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
