...
public final class TcfEuV2PublisherPurposesSegment extends AbstractLazilyEncodableSegment<TcfEuV2Field, EncodableBitStringFields<TcfEuV2Field>> {
  ...
  protected EncodableBitStringFields<TcfEuV2Field> initializeFields() {
    EncodableBitStringFields<TcfEuV2Field> fields = new EncodableBitStringFields<>(TcfEuV2Field.TCFEUV2_PUBLISHER_PURPOSES_SEGMENT_FIELD_NAMES);
