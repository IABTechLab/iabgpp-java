...
public class UsMtGpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public List<String> getFieldNames() {
    return UsMtField.USMT_GPC_SEGMENT_FIELD_NAMES;
  }
  ...
  protected EncodableBitStringFields initializeFields() {
    ...
    fields.put(UsMtField.GPC_SEGMENT_INCLUDED, new EncodableBoolean(true));
