...
public final class UsCoGpcSegment extends AbstractLazilyEncodableSegment<UsCoField, EncodableBitStringFields<UsCoField>> {
  ...
  protected EncodableBitStringFields<UsCoField> initializeFields() {
    EncodableBitStringFields<UsCoField> fields = new EncodableBitStringFields<>(UsCoField.USCO_GPC_SEGMENT_FIELD_NAMES);
    fields.put(UsCoField.GPC_SEGMENT_TYPE, new EncodableFixedInteger(2, 1));
    fields.put(UsCoField.GPC_SEGMENT_INCLUDED, new UnencodableBoolean(true));
