...
public class Base64UrlEncoder {
  ...
  // prettier-ignore
  private static Map<Character, Integer> REVERSE_DICT = Stream.of(new Object[][] { 
  ...
  private static Pattern BASE64URL_VERIFICATION_PATTERN = Pattern.compile("^[A-Za-z0-9\\-_]*$", Pattern.CASE_INSENSITIVE);
