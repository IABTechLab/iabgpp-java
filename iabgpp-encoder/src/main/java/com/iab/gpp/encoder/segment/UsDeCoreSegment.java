...
public final class UsDeCoreSegment extends AbstractLazilyEncodableSegment<UsDeField, EncodableBitStringFields<UsDeField>> {
  ...
  protected EncodableBitStringFields<UsDeField> initializeFields() {
    EncodableBitStringFields<UsDeField> fields = new EncodableBitStringFields<>(UsDeField.USDE_CORE_SEGMENT_FIELD_NAMES);
