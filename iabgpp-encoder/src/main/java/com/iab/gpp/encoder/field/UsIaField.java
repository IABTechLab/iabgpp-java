...
public class UsIaField {
  ...
  //@formatter:off
  public static final List<String> USIA_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsIaField.VERSION,
  ...
  //@formatter:off
  public static final List<String> USIA_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
