...
public final class UsIaGpcSegment extends AbstractLazilyEncodableSegment<UsIaField, EncodableBitStringFields<UsIaField>> {
  ...
  protected EncodableBitStringFields<UsIaField> initializeFields() {
    EncodableBitStringFields<UsIaField> fields = new EncodableBitStringFields<>(UsIaField.USIA_GPC_SEGMENT_FIELD_NAMES);
