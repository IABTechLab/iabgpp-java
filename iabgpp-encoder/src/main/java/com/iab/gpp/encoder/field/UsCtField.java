...
public class UsCtField {
  ...
  //@formatter:off
  public static final List<String> USCT_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsCtField.VERSION,
  ...
  //@formatter:off
  public static final List<String> USCT_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
