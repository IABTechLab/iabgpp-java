...
public class UsCtV1GpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {

  private AbstractBase64UrlEncoder base64UrlEncoder = CompressedBase64UrlEncoder.getInstance();
  private BitStringEncoder bitStringEncoder = BitStringEncoder.getInstance();

  public UsCtV1GpcSegment() {
    super();
  }

  public UsCtV1GpcSegment(String encodedString) {
    super();
  ...
  public List<String> getFieldNames() {
    return UsCtV1Field.USCTV1_GPC_SEGMENT_FIELD_NAMES;
  }
