...
public class UsOrGpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public UsOrGpcSegment(String encodedString) {
    super();
  ...
  public List<String> getFieldNames() {
    return UsOrField.USOR_GPC_SEGMENT_FIELD_NAMES;
  }
  ...
  protected EncodableBitStringFields initializeFields() {
    ...
    fields.put(UsOrField.GPC_SEGMENT_INCLUDED, new EncodableBoolean(true));
