...
public final class UsOrCoreSegment extends AbstractLazilyEncodableSegment<UsOrField, EncodableBitStringFields<UsOrField>> {
  ...
  protected EncodableBitStringFields<UsOrField> initializeFields() {
    EncodableBitStringFields<UsOrField> fields = new EncodableBitStringFields<>(UsOrField.USOR_CORE_SEGMENT_FIELD_NAMES);
