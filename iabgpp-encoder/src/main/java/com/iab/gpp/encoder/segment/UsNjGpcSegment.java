...
public final class UsNjGpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  protected EncodableBitStringFields initializeFields() {
    EncodableBitStringFields fields = new EncodableBitStringFields(UsNjField.USNJ_GPC_SEGMENT_FIELD_NAMES);
