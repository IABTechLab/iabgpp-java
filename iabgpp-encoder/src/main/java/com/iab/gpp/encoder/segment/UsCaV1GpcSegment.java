...
public class UsCaV1GpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {

  private AbstractBase64UrlEncoder base64UrlEncoder = CompressedBase64UrlEncoder.getInstance();
  private BitStringEncoder bitStringEncoder = BitStringEncoder.getInstance();

  public UsCaV1GpcSegment() {
    super();
  }

  public UsCaV1GpcSegment(String encodedString) {
    super();
  ...
  public List<String> getFieldNames() {
    return UsCaV1Field.USCAV1_GPC_SEGMENT_FIELD_NAMES;
  }
  ...
  protected void decodeSegment(String encodedString, EncodableBitStringFields fields) {
    ...
    try {
      ...
      throw new DecodingException("Unable to decode UsCaV1GpcSegment '" + encodedString + "'", e);
    }
  }
}
