...
public class UsCtV1Field {
  ...
  //@formatter:off
  public static final List<String> USCTV1_CORE_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
      UsCtV1Field.VERSION,
  ...
  //@formatter:off
  public static final List<String> USCTV1_GPC_SEGMENT_FIELD_NAMES = Arrays.asList(new String[] {
